<?php
    ...
    echo       '<li role="presentation" class="active"><a href="./index.html">Home</a></li>';
    echo       '<li role="presentation"><a href="./school.html">School</a></li>';
    echo       '<li role="presentation"><a href="./work.html">Work</a></li>';
    echo       '<li role="presentation"><a href="./contact.html">Contact</a></li>';
    echo     '</ul>';
    ...
    if (isset($_POST['submit'])) {
        ...
        /*
        if (isset($_POST['contactRadio']) && $_POST['contactRadio'] != ""){
            $contactRadio=$_POST['contactRadio'];
		    $_SESSION['contactRadio']=$contactRadio;
        }else {
            $err.= "contactRadioNull";
        }*/
